      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className={cn("w-[--sidebar-width] p-0 text-sidebar-foreground [&>button]:hidden bg-sidebar", className)}
            style={
              {
...
>(({ className, ...props }, ref) => {
  ...
  if (isMobile) {
    // On mobile, we wrap the header in a SheetTitle for accessibility.
    return (
      <SheetTitle asChild>
        <div
          ref={ref}
